...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-dark flex">
      {/* Sidebar */}
      <aside className="w-64 border-r border-white/10 bg-dark/80 backdrop-blur-md hidden md:flex flex-col">
        <div className="p-6">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-red-500 flex items-center justify-center font-heading font-bold text-lg text-white">
              A
            </div>
        ...
        <div className="p-4 border-t border-white/10">
          <Link href="/admin/settings" className="flex items-center gap-3 px-4 py-3 rounded-xl w-full text-left text-gray-400 hover:text-white hover:bg-white/5 transition-colors mb-2">
            <Settings size={20} />
