...
export default function Footer() {
  return (
    <footer className="bg-dark/50 border-t border-white/10 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-gray-400">
              ...
              <li><Link href="#tracks" className="hover:text-white transition-colors">Hackathon Tracks</Link></li>
              <li><Link href="#timeline" className="hover:text-white transition-colors">Event Timeline</Link></li>
              <li><Link href="#prizes" className="hover:text-white transition-colors">Prizes & Awards</Link></li>
              <li><Link href="#sponsors" className="hover:text-white transition-colors">Our Sponsors</Link></li>
            </ul>
          </div>
